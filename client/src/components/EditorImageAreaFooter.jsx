    ...
    <div className='h-[60px] w-full flex items-center justify-between border-t px-4'>
        ...
        <div className='flex items-center gap-2'>
            ...
            <div className='flex items-center gap-2'>
              ...
              <input className="appearance-none cursor-pointer w-[200px] h-1 rounded-full bg-gray-200 outline-none focus:outline-none  focus:bg-gray-300 focus:ring-2 focus:ring-0" type="range" name="" id="" />
